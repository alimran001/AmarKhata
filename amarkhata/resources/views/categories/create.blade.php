...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h2 class="mb-0">নতুন বিভাগ তৈরি</h2>
    ...
    <div class="card mb-3" style="border-color: #E4BE06;">
        <div class="card-body">
            <form action="{{ route('categories.store') }}" method="POST">
                ...
                <div class="mb-3">
                    <label for="type" class="form-label">বিভাগের ধরণ <span style="color: #FE5B56;">*</span></label>
                    <select name="type" id="type" class="form-select" required>
                        <option value="">ধরণ নির্বাচন করুন</option>
                        <option value="income" {{ old('type') == 'income' ? 'selected' : '' }}>আয়</option>
                        <option value="expense" {{ old('type') == 'expense' ? 'selected' : '' }}>ব্যয়</option>
                    </select>
                ...
                <div class="mb-3">
                    ...
                    <div class="d-flex align-items-center">
                        <input type="color" name="color" id="color" value="{{ old('color', '#E4BE06') }}" class="form-control form-control-color">
                ...
                <div class="mb-3">
                    ...
                    <div class="row row-cols-4 g-2 mb-2" id="icon-container">
                        ...
                        @foreach($icons as $icon)
                            <div class="col">
                                <div class="icon-selection p-3 border rounded text-center {{ (old('icon') == $icon) ? 'selected' : '' }}" data-icon="{{ $icon }}" style="border-color: #E4BE06; cursor: pointer;">
                ...
                <div class="d-grid">
                    <button type="submit" class="btn btn-primary btn-lg">
                        <i class="fas fa-save me-1"></i> বিভাগ তৈরি করুন
                    </button>
                </div>
            </form>
        </div>
