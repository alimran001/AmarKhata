        ...
        <div class="col-12">
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">কাস্টম রিপোর্ট</h5>
                    <div>
                        <a href="{{ route('reports.download', ['type' => 'custom', 'start_date' => $startDate->format('Y-m-d'), 'end_date' => $endDate->format('Y-m-d')]) }}" class="btn btn-sm btn-light">
                            <i class="bi bi-download"></i> পিডিএফ ডাউনলোড
                        </a>
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{ route('reports.custom') }}" method="GET" class="mb-4">
                        <div class="row g-3">
                            <div class="col-md-5">
                        ...
                        <div class="col-md-4">
                            <div class="card text-bg-success">
                                <div class="card-body">
                                    ...
                                    <h3>{{ number_format($totalIncome, 2) }} টাকা</h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="card text-bg-danger">
                                <div class="card-body">
                                    ...
                                    <h3>{{ number_format($totalExpense, 2) }} টাকা</h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="card {{ $balance >= 0 ? 'text-bg-info' : 'text-bg-warning' }}">
                                <div class="card-body">
                                    <h5 class="card-title">ব্যালেন্স</h5>
                                    <h3>{{ number_format($balance, 2) }} টাকা</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="card-body">
                                            <table class="table table-bordered mb-0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end fw-bold text-success">{{ number_format($givenLoans['paid_in_range'], 2) }} টাকা</td>
                                                </tr>
                                                <tr>
                                    ...
                                    <div class="card mb-3">
                                        ...
                                        <div class="card-body">
                                            <table class="table table-bordered mb-0">
                                                ...
                                                <tr>
                                                    <td>এই সময়ে পরিশোধ</td>
                                                    <td class="text-end fw-bold text-success">{{ number_format($takenLoans['paid_in_range'], 2) }} টাকা</td>
                                                </tr>
                                                <tr>
                                                    <td>অবশিষ্ট পরিমাণ</td>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0">লেনদেন তালিকা</h5>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @else
                                                        <span class="badge bg-secondary">ক্যাটাগরি নেই</span>
                                                    @endif
                                                </td>
                                                <td>
